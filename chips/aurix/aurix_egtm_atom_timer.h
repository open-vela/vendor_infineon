...
#ifndef __VENDOR_INFINEON_CHIPS_AURIX_AURIX_EGTM_ATOM_TIMER__H
#define __VENDOR_INFINEON_CHIPS_AURIX_AURIX_EGTM_ATOM_TIMER__H
...
struct aurix_egtm_atom_timer_config_s
{
  IfxEgtm_Cluster               cluster;
  IfxEgtm_Atom_Ch               channel;
...
#endif /* CONFIG_AURIX_EGTM_ATOM_TIMER */
