...
LCF_TRAPVEC3_START = 0x80A00000;
LCF_TRAPVEC4_START = 0x80E00000;
LCF_TRAPVEC5_START = 0x81200000;
...
MEMORY
{
    ...
    pfls0_nc (rx!p): org = 0xa0000000, len = 4M
    ...
    cpu0_dlmu_nc (w!xp): org = 0xb0000000, len = 512K
...
/*Sections located at absolute fixed address*/
    ...
    SECTIONS
    {
        ...
        .start_tc2 (LCF_STARTPTR_CPU2) : FLAGS(rxl) { KEEP (*(.start_cpu2)); } > pfls2
        .start_tc3 (LCF_STARTPTR_CPU3) : FLAGS(rxl) { KEEP (*(.start_cpu3)); } > pfls3
        .start_tc4 (LCF_STARTPTR_CPU4) : FLAGS(rxl) { KEEP (*(.start_cpu4)); } > pfls4
        .start_tc5 (LCF_STARTPTR_CPU5) : FLAGS(rxl) { KEEP (*(.start_cpu5)); } > pfls5
        PROVIDE(__START1 = LCF_STARTPTR_CPU1);
        PROVIDE(__START2 = LCF_STARTPTR_CPU2);
        PROVIDE(__START3 = LCF_STARTPTR_CPU3);
        PROVIDE(__START4 = LCF_STARTPTR_CPU4);
        PROVIDE(__START5 = LCF_STARTPTR_CPU5);
    }
